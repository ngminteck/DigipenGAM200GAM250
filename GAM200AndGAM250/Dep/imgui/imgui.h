...
namespace ImGui
{
	...
	IMGUI_API bool          ThumbNail(ImTextureID user_texture_id, const ImVec2& size, std::string * labelconst, bool double_click = true ,const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1));
	...
	IMGUI_API bool          DragScalarInput(const char* label, ImGuiDataType data_type, void* v, float v_speed, const void* v_min = NULL, const void* v_max = NULL, const void* step = NULL, const void* step_fast = NULL, const char* format = NULL, float power = 1.0f , ImGuiInputTextFlags extra_flags = 0);

    IMGUI_API bool          DragScalarN(const char* label, ImGuiDataType data_type, void* v, int components, float v_speed, const void* v_min = NULL, const void* v_max = NULL, const char* format = NULL, float power = 1.0f);

	IMGUI_API bool          DragScalarInputN(const char* label, ImGuiDataType data_type, void* v, int components, float v_speed, const void* v_min = NULL, const void* v_max = NULL, const void* step = NULL, const void* step_fast = NULL, const char* format = NULL, float power = 1.0f , ImGuiInputTextFlags extra_flags = 0);
