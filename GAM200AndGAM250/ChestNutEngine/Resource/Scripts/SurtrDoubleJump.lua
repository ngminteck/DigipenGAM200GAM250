...
This script controls the DOUBLE-JUMPING. I just copied and paste the normal jump code and made some changes so expect
unnecessary shit.
...
function Start(sceneactor)
	...
	-- Jump variables
	jumpHeight = 9 -- surtr jump height
...
function ExecuteJump()
	...
	elseif (_G.i:KeyUp(KEY_JUMP) and _G.i:KeyUp(KEY_ALTJUMP) and not _G.xbox:KeyDown(BUTTON_A)) then
